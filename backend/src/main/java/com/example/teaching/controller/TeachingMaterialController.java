...
public class TeachingMaterialController {
     ...
     * @return 教学资料列表
     */
    @Operation(summary = "根据课程 ID 获取教学资料")
     ...
     * @return 教学资料列表
     */
    @Operation(summary = "根据教师 ID 获取教学资料")
